...
## ソースコードの説明
78　サイズがNodeの分あるデータの先頭アドレスをpNodeに代入する

79　pNodeが指すデータcityにnewcityを代入する。

80 pNodeの次のアドレスを指すpNextにpNextを代入する

81 return(pNode)で先頭アドレスを出力する

104,105 i,jともに-1とおく

106~108  jをcityすべて見終わったときを終了とし、ｊを一つずつ増やしていく

109~115 pLIstの中にあるcity.idとkeyと同じであるIDを比較して、同じであればiにｊを代入してwhileからでる。同じでない場合whileによって比較を続ける。

117 一致するidがあった場合iにはjが入り場所がわかる。一致するものがない場合iには -1が入っている。
...
bb35319047@LAPTOP-ADOH2LUM MINGW64 ~/Desktop/2020psp3-2/k02 (develop)
$ ./k02
42201, 長崎県, 長崎市, 429508, 198716, 230792
42202, 長崎県, 佐世保市, 255439, 120198, 135241
42203, 長崎県, 島原市, 45436, 20999, 24437
